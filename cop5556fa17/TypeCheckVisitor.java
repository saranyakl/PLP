...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitDeclaration_Variable(
		...
		if(declaration_Variable.e!=null) {
			...
			throw new SemanticException(declaration_Variable.firstToken, "From declaration_Variable, expression not found");
...
//						expression_Binary.ntype = Type.NONE;
			...
			throw new SemanticException(expression_Binary.firstToken, "From expression_Binary, expressions not found");
		...
		if(expression_Unary.e!=null) {
			...
			case OP_EXCL:
				if(et==Type.BOOLEAN || et==Type.INTEGER) {
					...
					throw new SemanticException(expression_Unary.firstToken,"expression_Unary, require failed");
				break;
			...
			throw new SemanticException(expression_Unary.firstToken, "From expression_Unary, expression not found");
	...
	public Object visitIndex(Index index, Object arg) throws Exception {
		if(index.e0!=null && index.e1!=null) {
			...
			throw new SemanticException(index.firstToken, "From index, expressions not found");
		return index.ntype;
	}
	...
	public Object visitExpression_Conditional(
		...
		if(expression_Conditional.condition!=null && expression_Conditional.falseExpression!=null 
			...
			throw new SemanticException(expression_Conditional.firstToken, "expression_conditional, expressions not found");
	...
	public Object visitDeclaration_Image(Declaration_Image declaration_Image,
		...
		if(declaration_Image.xSize!=null && declaration_Image.ySize!=null && declaration_Image.source!=null) {
			Type xt = (Type) declaration_Image.xSize.visit(this, null);
			Type yt = (Type) declaration_Image.ySize.visit(this, null);
	...
	public Object visitSource_CommandLineParam(
		...
		if(source_CommandLineParam.paramNum!=null) {
			...
			throw new SemanticException(source_CommandLineParam.firstToken, "from source_commandlineparam, expression not found");
	...
	public Object visitDeclaration_SourceSink(
		...
		if(declaration_SourceSink.source!=null) {
			...
			throw new SemanticException(declaration_SourceSink.firstToken, "From declaration_sourcesink, Source not found");
	...
	public Object visitExpression_FunctionAppWithExprArg(
		...
		if(expression_FunctionAppWithExprArg.arg!=null) {
			...
			throw new SemanticException(expression_FunctionAppWithExprArg.firstToken, "From expression_FunctionAppWithExprArg, expression not found");
	...
	public Object visitExpression_FunctionAppWithIndexArg(
		...
		if(expression_FunctionAppWithIndexArg.arg!=null)
			...
			throw new SemanticException(expression_FunctionAppWithIndexArg.firstToken, 
					"From expression_FuncAppwithIndexArg, no Index found");
	...
	public Object visitStatement_Out(Statement_Out statement_Out, Object arg)
		...
		if(statement_Out.sink!=null) {
			...
			throw new SemanticException(statement_Out.firstToken, "Ffrom ststatement_out, sink not found");
	...
	public Object visitStatement_In(Statement_In statement_In, Object arg)
		...
		if(statement_In.source!=null) {
			...
			throw new SemanticException(statement_In.firstToken, "From statement_in, source not found");
	...
	public Object visitStatement_Assign(Statement_Assign statement_Assign,
		...
		if(statement_Assign.lhs!=null && statement_Assign.e!=null) {
			...
			throw new SemanticException(statement_Assign.firstToken, "From statement_Assign, lhs or expression not found");
	...
	public Object visitLHS(LHS lhs, Object arg) throws Exception {
		if(lhs.index!=null) {
			...
			throw new SemanticException(lhs.firstToken, "From lhs: No index found");
		return lhs.ntype;
	}
